...
/**
 * SQL Operator for IS NOT TYPED predicate (ISO-GQL standard).
 * Checks if a value is NOT of a specified type.
 * Example: n.id IS NOT TYPED STRING
 */
public class SqlIsNotTypedOperator extends SqlOperator {

    public static final SqlIsNotTypedOperator INSTANCE = new SqlIsNotTypedOperator();

    protected SqlIsNotTypedOperator() {
        super("IS NOT TYPED", SqlKind.OTHER, 2, true,
